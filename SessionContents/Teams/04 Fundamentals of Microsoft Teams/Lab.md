...
1. Type `md lk-teams-app1` and press **Enter**.

1. Type `cd lk-teams-app1` and press **Enter**.
...
1. Select **Use the current folder** for the file location and select **Enter**. The next set of prompts asks for specific information about your Microsoft Teams app:
    ...
    - Enter **https://lk-teams-app-temp.ngrok.io** as the URL where you will host this tab and press **Enter**. You will change this URL later in the exercise.
